...
?>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="col-lg-12 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
            <h3><?php echo $rowblog['judul'] ?></h3>
            <h4><?php echo "@"; echo $rowblog['penulis']; echo " "; echo $rowblog['create_date']; ?></h4>
           <hr>
            </div>
          <div class="col-lg-12 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100" style= "padding-bottom : 50px;">
          
            <img src="assets/img/blog/<?php echo $rowblog['gambar']; ?>" class="img-fluid" alt="" style="width: 800px;">
           
          </div>

          <div class="col-lg-12 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
                <p style="text-align : justify;"><?php echo $rowblog['deskripsi']; ?></p>
        </div>
